...
{
    $siswa = Siswa::find($id);
    $kelass = Kelas::all(); // Ambil semua data kelas untuk dropdown
    ...
    return view('siswas.edit', [
        'siswa' => $siswa,
        'kelass' => $kelass // Kirim data kelas ke view
    ]);
}
    ...
    public function innerJoin()
{
    ...
    return view('siswas.inner-join', compact('siswas'));
}
}
